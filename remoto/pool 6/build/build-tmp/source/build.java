...
public void setup(){
	...
	c1 = new HCanvas().blend(MULTIPLY).fade(1);
	c2 = new HCanvas().blend(MULTIPLY).fade(1);
	H.add(c1);
	H.add(c2);
	
	colors1 = new HPixelColorist("mancha1080.png").fillOnly();
	colors2 = new HColorPool( 0xff66ccff, 0xffECECEC, 0xff0066ff, 0xff003366, 0xffff761a, 0xff0066ff, 0xff003366, 0xffff761a);
	colors3 = new HColorPool( 0xff66ccff, 0xffECECEC, 0xff0066ff, 0xff003366, 0xffff761a);
	colors4 = new HColorPool( 0xff66ccff, 0xffECECEC, 0xff66ccff, 0xffECECEC,0xff0066ff, 0xff003366, 0xffff761a);
}
...
public void draw(){
	...
	if (mousePressed) {
			...
			pool1.shuffleRequestAll();
	 		...
	 		// c1.paintAll(tmp, false, 1);
	 		// c2.paintAll(tmp, false, 1);
			endRecord();
	 		H.drawStage();
			pool1.drain(true);
			pool2.drain(true);
