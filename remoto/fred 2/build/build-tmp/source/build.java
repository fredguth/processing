...
public void setup(){
	...
	//
	colors2 = new HColorPool(0xffFFFFFF, 0xffFFFFFF, 0xffFFFFFF,  0xff0066ff, 0xff003366);
...
public void draw(){
	...
	pool1.autoParent(c1)
		...
		// .add(new HShape("11.svg"))
		// .add(new HShape("12.svg"))
		// .add(new HShape("13.svg"))
		// .add(new HShape("14.svg"))
		// .add(new HShape("15.svg"))
		// .add(new HShape("16.svg"))
