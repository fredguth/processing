...
void draw(){
	...
	pool.autoAddToStage()
		...
		// .add(new HShape("triangulo_GG.svg"),2)
		// .add(new HShape("quadrado.svg"),8)
		// .add(new HShape("asadelta.svg"),4)
		// .add(new HShape("asadelta_GG.svg"),2)
		// .add(new HShape("bola.svg"))
		// .add(new HShape("meialua.svg"))
		...
		.onRequest(
			new HCallback() {
				public void run(Object obj) {
					HShape d = (HShape) obj;
					//int weight = (int) colors.getColor(d.x(), d.y())/5;
					int s = (int) colors.getColor(d.x(), d.y())/255;
